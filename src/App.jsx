    ...
    <>
      <main>
        <section className="testimonals flex flex-col justify-center items-center w-full min-h-screen  bg-[url(/images/pattern-curve.svg)] bg-no-repeat bg-left-bottom bg-[length:285px_72px] md:flex-row-reverse md:bg-[length:400px_100px] xl:bg-[length:610px_150px] ">
          <div className={`image-container relative flex flex-col justify-center items-center w-[327px] h-[308px]  bg-[url(/images/pattern-bg.svg)] bg-cover bg-no-repeat md:absolute md:right-[10%] md:p-8 md:w-[360px] md:h-[360px] xl:w-[600px] xl:h-[650px] ${animationClass}`}>
          <img
          ...
          <article className={`testimonials_content text-center my-8 pt-4 h-[228px] w-[311px] bg-[url(/images/pattern-quotes.svg)] bg-no-repeat bg-top bg-[length:60px_50px] md:absolute md:left-[5%] md:top-[25%] md:w-[350px] lg:left-[10%] lg:w-[635px] md:text-left ${animationClass}`}>
